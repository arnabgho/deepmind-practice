"""
Unit tests for Design Time Based Key Value Store
"""
import unittest
import sys
import os
...
class TestDesignTimeBasedKeyValueStore(unittest.TestCase):
    """Test cases for Design Time Based Key Value Store"""
