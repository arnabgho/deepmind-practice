"""
Unit tests for Shortest Path With Obstacles Elimination
"""
import unittest
import sys
import os
...
class TestShortestPathWithObstaclesElimination(unittest.TestCase):
    """Test cases for Shortest Path With Obstacles Elimination"""
